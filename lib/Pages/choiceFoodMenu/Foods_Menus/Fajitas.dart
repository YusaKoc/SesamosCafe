                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Image.asset("images/fajita.png",fit: BoxFit.contain,),
                          ),
                        ),
                        Text(
                          "ETLİ FAJITA",
                ...
                Padding(
                  ...
                  child: Card(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        SizedBox(width: 150,child: Image.asset("images/fajita.png",fit: BoxFit.contain,)),
                        Row(
                          children: [
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(backgroundColor: Colors.white,shadowColor: Colors.orange),
                            onPressed: (){},
                            child: Text(" 340 ₺",style: TextStyle(fontFamily: "Georgia",color: Colors.orangeAccent,fontWeight:FontWeight.bold ),),
                          ),
                        )
                      ],
                    ),
